...
render() {
    ...
    console.log(this.state.countTicket);

    const getChoosenSeats = () => {
        if (this.state.countTicket === count) {
            this.setState({
            ...
            this.setState ({
                errMess: 'Vui lòng chọn số ghế theo vé đã đặt'
            })
        }
    ...
    return (
        <div className='SelectSeatsPanel'>
            ...
            <div className='cus-iframe'>
                ...
                Nếu bạn muốn chọn loại ghế khác hoặc thay đổi số lượng vé muốn mua vui lòng nhấp vào
