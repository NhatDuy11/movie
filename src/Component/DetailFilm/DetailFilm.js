...
class DetailFilm extends Component {
    ...
    render() {
        ...
        const goPayment = (ShowTime, Title, GraphicUrl) => {
            this.setState({
                newDate: localStorage.setItem('time', DateTimeConvert(ShowTime, '#DD#-#M#-#YYYY#, #hhhh#:#mm# #AMPM#')),
                                            ...
                                            <div className='product--view'>
                                                ...
                                                <div className='time'>
                                                    {this.props.uRdc.lsSchedule.filmSchedule[i2].VersionsCaptions[0].ShowTimes.map((m, i) => {
                                                        return (
                                                            <div key={i}>
                                                                <ul className='film--info' onClick={() => { goPayment(m.ShowTime, n2.Title, n2.GraphicUrl) }}>
                                                                    <li>
